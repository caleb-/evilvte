...
#if defined(HOTKEY_TOGGLE_FULLSCREEN) || defined(MENU_TOGGLE_FULLSCREEN)
...
int main(int argc, char **argv)
{
  ...
  char windowid[16];
  g_snprintf(windowid, 16, "%d", (int)gdk_x11_drawable_get_xid(gtk_widget_get_window(main_window)));
